//! Próbkowanie informacji systemowych w osobnym wątku (sysinfo + /sys, /proc).
...
fn local_ipv4() -> Option<String> {
    // UDP connect nie wysyła żadnych pakietów — tylko wybiera interfejs.
...
pub fn start() -> Arc<Mutex<Snapshot>> {
    ...
    std::thread::spawn(move || {
        ...
        loop {
            ...
            // Suma ruchu po wszystkich interfejsach poza lo.
            ...
            // Ping co 5 s (TCP do 1.1.1.1:80) — wyłączany przez NGTERM_OFFLINE.
...
/// Formatowanie bajtów jak w eDEX (GiB/MiB/KiB).

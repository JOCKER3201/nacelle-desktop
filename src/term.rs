//! Emulacja terminala: siatka znaków + obsługa sekwencji VT (parser: vte).
...
/// Druga komórka znaku o podwójnej szerokości.
...
pub struct Term {
    ...
    wrap_pending: bool,
    autowrap: bool,
    /// Przewinięcie widoku w górę (liczba linii scrollbacku).
    pub view_offset: usize,
    /// Odpowiedzi do wysłania do PTY (DA, CPR itd.).
    pub responses: Vec<u8>,
    /// Tytuł ustawiony przez OSC 0/2.
    pub title: String,
}
...
impl Term {
    ...
    /// Linia widoczna na ekranie z uwzględnieniem przewinięcia.
    ...
    fn put_char(&mut self, c: char) {
        ...
        if width == 0 {
            return; // znaki łączące pomijamy (uproszczenie)
        }

//! Renderer Vulkan (ash) — jeden pipeline (trójkąty z teksturą atlasu),
//! jeden bufor wierzchołków przeładowywany co klatkę, atlas glifów R8.
...
impl Gfx {
    pub fn new(window: &winit::window::Window) -> Self {
        unsafe {
            let entry = ash::Entry::load().expect("nie można załadować biblioteki Vulkan");
            ...
            let ext_names = ash_window::enumerate_required_extensions(display_handle)
                .expect("brak rozszerzeń surface")
                .to_vec();
            ...
            let instance = entry
                ...
                .expect("nie można utworzyć instancji Vulkan");
            ...
            .expect("nie można utworzyć powierzchni okna");
            let surface_loader = ash::khr::surface::Instance::new(&entry, &instance);

            // Wybór GPU + rodziny kolejek (grafika + prezentacja).
            let pdevices = instance
                .enumerate_physical_devices()
                .expect("brak urządzeń Vulkan");
            let (pdevice, queue_family) = pdevices
                ...
                .expect("brak GPU z obsługą grafiki i prezentacji");
            ...
            let device = instance
                ...
                .expect("nie można utworzyć urządzenia logicznego");
            let queue = device.get_device_queue(queue_family, 0);
            let swapchain_loader = ash::khr::swapchain::Device::new(&instance, &device);

            // Format powierzchni: preferujemy UNORM (kolory zapisujemy wprost).
            ...
            // Deskryptory: tekstura atlasu (binding 0) + sampler (binding 1),
            // bo WGSL nie ma combined image sampler.
            let bindings = [
            ...
            // Bufor staging do wgrywania atlasu.
            ...
            // Bufor wierzchołków (host-visible, mapowany na stałe).
    ...
    fn recreate_swapchain(&mut self, width: u32, height: u32) {
        unsafe {
            ...
            self.swapchain = self
                ...
                .expect("nie można utworzyć swapchaina");
    ...
    /// Renderuje klatkę. `atlas` podajemy tylko gdy atlas się zmienił.
    pub fn render(
        &mut self,
        ...
        unsafe {
            ...
            // Wgraj wierzchołki (bufor jest mapowany na stałe).
...
fn create_pipeline(
    ...
    unsafe {
        // Jeden moduł SPIR-V z dwoma punktami wejścia (vs_main / fs_main).
        ...
        let pipeline = device
            ...
            .expect("nie można utworzyć pipeline'u")[0];
...
fn find_memory_type(
    ...
    panic!("brak odpowiedniego typu pamięci GPU");
}
